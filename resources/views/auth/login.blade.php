...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('assets/backend/bower_components/bower_components/font-awesome/css/font-awesome.min.css')}}">
    <!-- Ionicons -->
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ route('login') }}"><b>ECommerce</b>Admin</a>
    </div>
    <!-- /.login-logo -->
